...
public class FAQ extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "First Model", version = "1.0",
          description = "A las2peer microservice generated by the CAE.",
          termsOfService = "none",
          contact = @Contact(name = "melisa", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/testcae/microservice-First-Model/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getFAQS(String res) {
